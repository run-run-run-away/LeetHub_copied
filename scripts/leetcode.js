...
const upload = (
  ...
  const URL = `https://api.github.com/repos/${hook}/contents/Leetcode/${directory}/${hook.split("/")[0]}_${filename}`;
...
const update = (
  ...
  const URL = `https://api.github.com/repos/${hook}/contents/Leetcode/${directory}/${hook.split("/")[0]}_README.md`;
